...
class NormMultiWozCorpus(object):
    ...
    def process_dialog(self, data, corpus_type):
        data = self._process_dialogue(data)
        if corpus_type == 'train':
            self._extract_vocab(data)
            self._extract_goal_vocab(data)
    ...
    def _extract_goal_vocab(self, data):
