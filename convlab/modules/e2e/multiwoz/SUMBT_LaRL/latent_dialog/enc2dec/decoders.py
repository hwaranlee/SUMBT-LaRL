    ...
    def forward(self, batch_size, dec_inputs, dec_init_state, attn_context, mode, gen_type, beam_size, goal_hid=None):
        ...
        if mode == TEACH_FORCE:
            ...
            for step in range(self.max_dec_len):
                ...
                # print("decoder_hidden_state[0].shape: ", decoder_hidden_state[0].shape)
                # print("decoder_hidden_state[1].shape: ", decoder_hidden_state[1].shape)
                # print("step_attn.shape: ", step_attn.shape)
