...
DOMAIN_POS_WEIGHT=[7, 87, 3, 146, 3, 18, 4]
ACT_POS_WEIGHT=[56, 483, 5, \
30, 60, 26, 0, 0, 0, 0, 0, 0, 523, 26, 24, 25, 19, 34, 50, 32, 26, 25, 22, 18, 24, 25, 21, 12, 45, 17, 99, 74, 80, 69, 32, 32, 0, 16, 16, 16, 33, \
52, 178, 60, 49, 45, 272, 502, 419, 338, 121, 336, 272, 309, 145, 125, 245, 140, 1239, 474, 502, 996, 534, 49, 423, 470, 50, 76, 338, 126, 167, 1302, 208, 140, 248, 113, 65, 86]
...
class BeliefTracker(nn.Module):
    ...
    def forward(self, input_ids, input_len, labels=None, n_gpu=1, target_slot=None):
        ...
        if labels is None:    
            ...
            results['pred_domain'] = None
            results['pred_act'] = None
