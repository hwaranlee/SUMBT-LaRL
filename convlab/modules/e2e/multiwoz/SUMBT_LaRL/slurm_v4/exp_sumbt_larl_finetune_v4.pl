...
$tf_dir='tensorboard-1005v4-finetune-e2e'; #-patience30';
$out_dir='models-1005v4-finetune-e2e'; #-patience30';

$ptr_larl_dir='models-1004v4-ptr-larl/task=bert-gru-sumbt-lr=1e-3-y=10-beta=0.01--simple_posterior';
$ptr_sumbt_dir='models-1004v4-ptr-sumbt_v2/task=bert-gru-sumbt-lr=1e-4-bs=3-hd=300-apw=';

$task_name = "bert-gru-sumbt";

@max_epochs = ("100"); 
@warmup_props = ("0.1"); 
@learning_rates = ("0.0000316"); # 1e-4
@batch_sizes = ("3");
@hidden_dims =("300");
...
#@learning_schemes = ("", "--fix_utterance_encoder", "--pretrain_larl");
@learning_schemes = (""), ;#"--fix_utterance_encoder"); # , "--pretrain_larl");
...
foreach $act_pos_weight (@act_pos_weights)
{
	...
	push @params, "--output_dir $main_dir/$out_dir/lr=$learning_rate-y=$y_size-beta=$beta-hd=$hidden_dim-apw=$act_pos_weight";
