...
@hidden_dims =("300"); #, "600");
$tf_dir='tensorboard-multiwoz';
$out_dir='models-multiwoz';
@lambda_reqs = ("1"); #, "2"); #, "10", "20");
@req_pos_weights = ("1", "50", "100"); #"50", "100", "200"); #"10", "50", "100", "500");
...
foreach $target_slot (@target_slots)
{
	...
	push @params, "--data_dir /home/hwaranlee/06_convlab/data/multiwoz/sumbt_v2.1";
