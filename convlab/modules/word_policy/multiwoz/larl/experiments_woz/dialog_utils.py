import numpy as np
from convlab.modules.word_policy.multiwoz.larl.latent_dialog.enc2dec.decoders import GEN, DecoderRNN
from convlab.modules.word_policy.multiwoz.larl.latent_dialog.main import get_sent
